...
| Salvage / salvaging (actividad) | desguace / desguazar. NO: "chatarreo", "chatarrería", "salvamento". Ej: "salvage ship" → "nave de desguace", "salvage pilots" → "desguazadores", "salvage operation" → "operación de desguace", "salvage claim" → "reclamación de desguace" |
| Salvager (persona) | desguazador/a, desguazadores. NO: "chatarrero/a" |
| Salvage (material recuperado — el botín) | chatarra. NO: "desguace". Ej: "there's good salvage here" → "hay buena chatarra aquí", "claim the salvage" → "reclamar la chatarra" |
| Salvage (recuperación de carga específica, no chatarra) | recuperación. NO: "desguace". Ej: recuperar paquetes de zeta-prolanida → "recuperación exitosa de los materiales" |
| Scrap (commodity — nombre de item) | Scrap (mantener en inglés como nombre de item). En texto narrativo descriptivo: chatarra |
